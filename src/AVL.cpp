...
void AVL::AVLTree::insert(Node *& root, const std::string & word)
{
    if (root == nullptr)
        root = new Node(word);
    else if (word < root->word)
...
void AVL::AVLTree::sort(Node * root, std::vector<std::string>& v)
{
    if (root == nullptr)
        return;
...
void AVL::AVLTree::range(Node * root, const std::string & word1, const std::string & word2)
{
    if (root == nullptr)
        return;
...
void AVL::AVLTree::deleteWord(Node *& root, const std::string & word)
{
    if (root == nullptr)
        return;
    if (word < root->word)
...
void AVL::AVLTree::updateHeight(Node * root)
{
    if (root == nullptr)
        return;
...
void AVL::AVLTree::deleteNode(Node *& root)
{
    if (root == nullptr)
        return;
...
int AVL::AVLTree::checkBalance(Node *& root)
{
    if (root == nullptr)
        return 0;
...
void AVL::AVLTree::range(const std::string & word1, const std::string & word2)
{
